...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/01.png" caption="The game has a lovely low-poly look - filled with rich colours and cute slimes!" %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/02.gif" caption="Slime Rancher's displays show stacked pixels when up close, but they smoothly fade away as we move back from the screen." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/03.png" caption="Above you can see the UV coordinates for a quad - red being our X value (U), and green being our Y value (V). The space in between the corners is interpolated cleanly, resulting in smooth continuous values." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/04.png" caption="The X points to what we're returning within the block - the pixel block should always be returning the center of itself, not a corner!" %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/05.png" caption="Slime Rancher's cute pink plorts can be morphed from their original 1024x1024 resolution to whatever we need." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/06.gif" caption="The weird artifacts on the left as we zoom out are Moiré patterns, caused by the intersection of the sampling pattern and the texture's built-in pattern." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/07.gif" caption="And just like that a bunch of pretty pixels fade away to grey-ness. " %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/08.gif" caption="By blending through mipmaps we get a clean look from afar, as well as a nice blend to our pixels up close." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/10.gif" caption="This is getting there, but still causes some odd artifacts." %}
...
{% include elements/figure.html image="../../assets/images/shader_studies/slime_rancher/11.gif" caption="With a render texture hooked up and some minor improvements under the hood, our shader has finally come to fruition." %}
